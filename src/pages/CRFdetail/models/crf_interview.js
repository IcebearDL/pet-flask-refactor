...
import {
  FetchInterviewTable, ModifyInterview, DeleteInterview,
  FetchSummary, ModifySummary, FetchAdverseEventAll
...
const Model = {
    ...
    effects: {
      ...
      *modifyInterview({ payload }, { call, put }) {
      ...
      *modifySummary({ payload }, { call, put }) {
