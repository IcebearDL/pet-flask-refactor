...
export const FirstDiagnoseForm1 = connect(mapStateToProps)(
  Form.create()(FirstDiagnoseForm_1)
)
...
export const FirstDiagnoseForm2 = connect(mapStateToProps)(
  Form.create()(FirstDiagnoseForm_2)
)
...
export const FirstDiagnoseTable3 = connect(mapStateToProps)(
  Form.create()(FirstDiagnoseTable_3)
)
...
class FirstDiagnoseForm_4 extends React.Component {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        if (values.drinking_quit_time) {
          values.drinking_quit_time = values.drinking_quit_time.format(
            'YYYY-MM-DD'
          )
        }
  ...
  render() {
    ...
    const submitLoading = this.props.loading.effects[
      'crf_first_diagnose/modifyPatientHistory'
    ]
    const {
      surgery,
      tumor_ill,
      ...
      <Form {...formItemLayout} onSubmit={this.handleSubmit}>
          ...
          {getFieldDecorator('surgery', {
            ...
            <Radio.Group onChange={e => this.handleStateChange('surgery', e)}>
              ...
              <Radio value="其他">
                其他
                {surgery === '其他' ||
                (surgery === '' && patient_history.surgery === '其他') ? (
        ...
        <Form.Item label="基础疾病史：">
          ...
          <Form.Item className={styles.from_item}>
            {getFieldDecorator('base_ill[慢性阻塞性肺疾病]', {
              initialValue:
                patient_history['base_ill[慢性阻塞性肺疾病]'] === 'on',
              valuePropName: 'checked'
          ...
          <Form.Item className={styles.from_item}>
            {getFieldDecorator('base_ill[风湿免疫性疾病]', {
              initialValue:
                patient_history['base_ill[风湿免疫性疾病]'] === 'on',
              valuePropName: 'checked'
          ...
          {getFieldDecorator('tumor_ill', {
            ...
            <Radio.Group onChange={e => this.handleStateChange('tumor_ill', e)}>
              ...
              <Radio value="其他">
                其他
                {tumor_ill === '其他' ||
                (tumor_ill === '' && patient_history.tumor_ill === '其他') ? (
                  <div style={{ display: 'inline-block' }}>
        ...
        <Form.Item label="药物过敏史：">
          {getFieldDecorator('drug_allergy', {
            ...
            <Radio.Group
              onChange={e => this.handleStateChange('drug_allergy', e)}
            >
              <Radio value="无">无</Radio>
              <Radio value="不详">不详</Radio>
              <Radio value="其他">
                ...
                {drug_allergy === '其他' ||
                (drug_allergy === '' &&
                  patient_history.drug_allergy === '其他') ? (
                  <div style={{ display: 'inline-block' }}>
          ...
          {getFieldDecorator('drug_use', {
            ...
            <Radio.Group onChange={e => this.handleStateChange('drug_use', e)}>
              ...
              <Radio value="其他">
                其他
                {drug_use === '其他' ||
                (drug_use === '' && patient_history.drug_use === '其他') ? (
                  <div style={{ display: 'inline-block' }}>
        ...
        <Form.Item label="吸烟史：">
          ...
          {smoke || (smoke === null && patient_history.smoke === 'on') ? (
            <>
              ...
              {smoke_isquit ||
              (smoke_isquit === null &&
                patient_history.smoke_isquit === 'on') ? (
                <>
                  <Form.Item className={styles.smock_item}>
                    戒烟时间：
        ...
        <Form.Item label="饮酒史：">
          ...
          {drinking ||
          (drinking === null && patient_history.drinking === 'on') ? (
            <>
              ...
              <Form.Item className={styles.drinking_item}>
                ...
                {getFieldDecorator('drinking_is_quit', {
                  ...
                  <Switch
                    onChange={e =>
                      this.handleStateChange('drinking_is_quit', e)
                    }
                    checkedChildren="是"
                    unCheckedChildren="否"
                  />
              ...
              {drinking_is_quit ||
              (drinking_is_quit === null &&
                patient_history.drinking_is_quit === 'on') ? (
                <>
                  <Form.Item className={styles.drinking_item}>
                    戒酒时间：
                    {getFieldDecorator('drinking_quit_time', {
                      initialValue: patient_history.drinking_quit_time
                        ? moment(
                            patient_history.drinking_quit_time,
                            'YYYY-MM-DD'
                          )
                        : null
                    })(<DatePicker format="YYYY-MM-DD" />)}
                  ...
                  <Form.Item className={styles.drinking_item}>
                    ...
                    {getFieldDecorator('drinking_chemotherapy', {
                      initialValue:
                        patient_history.drinking_chemotherapy === 'on',
                      valuePropName: 'checked'
                    })(<Switch checkedChildren="是" unCheckedChildren="否" />)}
                  </Form.Item>
                </>
...
export const FirstDiagnoseForm4 = connect(mapStateToProps)(
  Form.create()(FirstDiagnoseForm_4)
)
...
class FirstDiagnoseForm_5 extends React.Component {
  ...
  render() {
    ...
    const submitLoading = this.props.loading.effects[
      'crf_first_diagnose/modifyFirstDiagnose'
    ]
    const {
      biopsy_method,
      tumor_pathological_type,
      ...
      >
        <Form.Item label="初诊临床症状">
          ...
          <Form.Item className={styles.from_item}>
            {getFieldDecorator('clinical_symptoms[体重下降]', {
              initialValue:
                first_diagnose['clinical_symptoms[体重下降]'] === 'on',
              valuePropName: 'checked'
        ...
        <Form.Item label="转移部位">
          ...
          <Form.Item className={styles.from_item}>
            {getFieldDecorator('transfer_site[对侧肺门淋巴结]', {
              initialValue:
                first_diagnose['transfer_site[对侧肺门淋巴结]'] === 'on',
              valuePropName: 'checked'
          ...
          <Form.Item className={styles.from_item}>
            {getFieldDecorator('transfer_site[锁骨上淋巴结肺内]', {
              initialValue:
                first_diagnose['transfer_site[锁骨上淋巴结肺内]'] === 'on',
              valuePropName: 'checked'
        ...
        <Form.Item label="活检方式">
          {getFieldDecorator('biopsy_method', {
            ...
            <Radio.Group
              onChange={e => this.handleStateChange('biopsy_method', e)}
            >
              <Radio value="无">无</Radio>
              ...
              <Radio value="其他">
                ...
                {biopsy_method === '其他' ||
                (biopsy_method === '' &&
                  first_diagnose.biopsy_method === '其他') ? (
                  <div style={{ display: 'inline-block' }}>
        ...
        <Form.Item label="肿瘤病理类型">
          {getFieldDecorator('tumor_pathological_type', {
            ...
            <Radio.Group
              onChange={e =>
                this.handleStateChange('tumor_pathological_type', e)
              }
            >
              ...
              <Radio value="混合型癌">
                ...
                (tumor_pathological_type === '' &&
                  first_diagnose.tumor_pathological_type === '混合型癌') ? (
                  <div style={{ display: 'inline-block' }}>
        ...
        <Form.Item label="基因检测标本">
          {getFieldDecorator('genetic_testing_specimen', {
            ...
            <Radio.Group
              onChange={e =>
                this.handleStateChange('genetic_testing_specimen', e)
              }
            >
              <Radio value="无">无</Radio>
              ...
              <Radio value="转移灶组织">
                ...
                (genetic_testing_specimen === '' &&
                  first_diagnose.genetic_testing_specimen === '转移灶组织') ? (
                  <div style={{ display: 'inline-block' }}>
                    {getFieldDecorator('genetic_testing_specimen_other', {
                      initialValue:
                        first_diagnose.genetic_testing_specimen_other
                    })(
                      <Input
                        style={{ width: 200, marginLeft: 15 }}
                        placeholder="其他标本"
        ...
        <Form.Item label="基因突变类型">
          ...
          <Form.Item className={styles.from_item}>
            {getFieldDecorator('gene_mutation_type[无突变]', {
              initialValue:
                first_diagnose['gene_mutation_type[无突变]'] === 'on',
              valuePropName: 'checked'
          ...
          <Form.Item className={styles.from_item}>
            {getFieldDecorator('gene_mutation_type[ROS-1]', {
              initialValue:
                first_diagnose['gene_mutation_type[ROS-1]'] === 'on',
              valuePropName: 'checked'
          ...
          <Form.Item className={styles.from_item}>
            {getFieldDecorator('gene_mutation_type[Her-2]', {
              initialValue:
                first_diagnose['gene_mutation_type[Her-2]'] === 'on',
              valuePropName: 'checked'
          ...
          <Form.Item className={styles.from_item}>
            {getFieldDecorator('gene_mutation_type[ERBB2]', {
              initialValue:
                first_diagnose['gene_mutation_type[ERBB2]'] === 'on',
              valuePropName: 'checked'
...
export const FirstDiagnoseForm5 = connect(mapStateToProps)(
  Form.create()(FirstDiagnoseForm_5)
)
...
export const FirstDiagnoseTable6 = connect(mapStateToProps)(
  Form.create()(FirstDiagnoseTable_6)
)
...
export const FirstDiagnoseForm7 = connect(mapStateToProps)(
  Form.create()(FirstDiagnoseForm_7)
)
...
export const FirstDiagnoseTable8 = connect(mapStateToProps)(
  Form.create()(FirstDiagnoseTable_8)
)
...
export const CycleRecordTable2 = connect(mapStateToProps)(
  Form.create()(CycleRecordTable_2)
)
...
export const CycleRecordForm4 = connect(mapStateToProps)(
  Form.create()(CycleRecordForm_4)
)
...
export const CycleRecordTable6 = connect(mapStateToProps)(
  Form.create()(CycleRecordTable_6)
)
...
export const AdverseEventTable = connect(mapStateToProps)(
  Form.create()(AdverseEventTable_)
)
